    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                Our platform is meticulously crafted to cater to the needs of both customers and administrators, 
                offering a comprehensive solution that simplifies the entire process from start to finish.
                 Whether you're a traveler looking to book your next journey or an administrator seeking efficient management tools, 
                 Bus Reservation System has you covered.
                </p>
            </div>
        </section>
        <section id="contact">
